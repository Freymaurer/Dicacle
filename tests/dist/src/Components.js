...
import { Main } from "./Pages/Page.Dicacle.js";
...
import { Main as Main_1 } from "./Components/Component.Navbar.js";
...
export function Components_Router() {
    ...
    }], (elements = singleton_1((children_7 = ofArray([createElement(Main_1, null), createElement("section", createObj(Helpers_combineClasses("hero", ofArray([["className", "is-fullheight-with-navbar"], (elems_3 = [(elms = toList(delay(() => ((currentPage.tag === 1) ? singleton(createElement(Components_HelloWorld, null)) : ((currentPage.tag === 2) ? singleton(createElement(Components_Counter, null)) : ((currentPage.tag === 3) ? singleton(createElement("h1", {
        children: ["Not found"],
